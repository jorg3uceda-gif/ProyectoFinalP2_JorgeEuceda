 ...
 * @author Jorge
 */
public class If extends Grafico{
    ...
    public If(Font font, String name, Color color, int width, int height, boolean fill) {
        super(font, name, color, width, height, fill);
    }

    public If(boolean inicio, Font font, String name, Color color, int width, int height, boolean fill) {
        super(font, name, color, width, height, fill);
        this.inicio = inicio;
    }

    
    public If(String condicion, boolean inicio, Font font, String name, Color color, int width, int height, boolean fill) {
        super(font, name, color, width, height, fill);
